...
function completely(container, config) {
        ...
        var p = {
            ...
            refresh : function(token, array) {
                ...
                for (var i=0;i<array.length;i++) {
                    //if (array[i].indexOf(token)!==0) { continue; } MODIFIED
                    ...
                    var tokenIndex = array[i].toLowerCase().indexOf(token.toLowerCase());
                    divRow.innerHTML = '<b>' + array[i].substr(0,tokenIndex) + '</b>' + token +'<b>'+array[i].substring(tokenIndex+token.length)+'</b>';
                    rows.push(divRow);
    ...
    var rs = { 
        ...
        repaint : function() {
            ...
            // xxx modified
            txtHint.value = leftSide + options[0];
