...
psql $DBNAME -c "CREATE TABLE stop_times (id text, arr text, dep text, stop text references stops(id), seq numeric, headsign text, pickup numeric, dropoff numeric, distance_travelled text, name text)" 2>/dev/null
echo Done
